...
import Upload_Avatar from "../upload/Upload_Avatar";

class AddContact extends React.Component {
  constructor(props) {
    super(props);

    const {id, thumb, name, email, phone, designation, selected} = props.contact;
    this.state = {
      id,
      thumb,
      name,
  ...
  render() {
    ...
    const {id, name, email, phone, designation, selected} = this.state;
      ...
      <Modal
        ...
        <div className="gx-modal-box-row">
          <div className="gx-modal-box-avatar">
            ...
            <Upload_Avatar size="large" thumb={thumb} onChangeThumb={this.onChangeThumb}/>
          </div>
